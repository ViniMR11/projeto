...
while (opcao != 0) {
    opção = readline.question("Digite uma opcao")
    ...
    if (opção == 1) {
        ...
        console.log("Presidente Prudente          Londres")
        console.log("Presidente Prudente          Avaí")
        console.log("Presidente Prudente          Paraiba")
    }
    else if (opção == 2) {
        console.log("+-----Passagens Aéreas-----+")
